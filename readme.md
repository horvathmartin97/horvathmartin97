...
This project was developed for Silver Arrow Car KFT as a digital showroom for used car sales.  
Users can register and log in to manage their own digital "parking lot" by adding cars. Admins have full CRUD access to all car listings.
...
> A minimal, dark-themed landing page for **Don Restaurants** in Baja, Hungary.
> Directs customers to the online ordering platforms of DonBoci and DonPipi.
...
- 🌑 Dark, modern UI with brand gradient accents
- 📱 Fully responsive (mobile-first, 1→2 column grid)
- 🔗 Direct links to online ordering platforms
- 📘 Facebook page links per restaurant
...
```bash
git clone [https://github.com/horvathmartin97/don-restaurants.git](https://github.com/horvathmartin97/my-showcase-projects/tree/main/donRedirectSite)
cd don-restaurants
npm install
npm run dev
